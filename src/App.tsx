...
export default function App() {
  ...
  return (
    <div className="min-h-screen" style={{ background: '#0D0F1A', color: '#FAFAF6' }}>
      ...
      {/* Agency trust signals — Cloudflare, encryption, beta count (all variants) */}
      {!communityChannel && <AgencyTrustStrip />}
      ...
      >
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-5 text-sm" style={{ color: 'rgba(250,250,246,0.3)' }}>
            ...
            <a href="/portal/signup?utm_source=peerscope_landing&utm_medium=footer_cta" className="hover:text-white transition-colors py-3 inline-block">Get started</a>
          </div>
        </div>
      </footer>
